...
WAIT_MSG = """"<b>𝙿𝚛𝚘𝚌𝚎𝚜𝚜𝚒𝚗𝚐...🏃🏻‍♂</b>"""

REPLY_ERROR = """<code>𝚄𝚜𝚎 𝚃𝚑𝚒𝚜 𝙲𝚘𝚖𝚖𝚊𝚗𝚍 𝙰𝚜 𝚊 𝚁𝚎𝚙𝚕𝚊𝚢 𝚃𝚘 𝙰𝚗𝚢 𝚃𝚎𝚕𝚎𝚐𝚛𝚊𝚖 𝙼𝚎𝚜𝚜𝚊𝚐𝚎 𝚆𝚒𝚝𝚑𝙾𝚞𝚝 𝙰𝚗𝚢 𝚂𝚙𝚊𝚌𝚎𝚜.</code>"""
    ...
    if len(text)>7:
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("♻️ ᴊᴏɪɴ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴘ ♻️", url="https://t.me/storytym")
                ]
            ]
        )
...
async def send_text(client: Bot, message: Message):
    if message.reply_to_message:
        ...
        status = f"""<b><u>Bʀᴏᴀᴅᴄᴀsᴛ Cᴏᴍᴘʟᴇᴛᴇᴅ ☄️</u>

Tᴏᴛᴀʟ Usᴇʀs 🙎🏿‍♂️: <code>{total}</code>
Sᴜᴄᴄᴇssғᴜʟ ✅: <code>{successful}</code>
Bʟᴏᴄᴋᴇᴅ Usᴇʀs ❎: <code>{blocked}</code>
Dᴇʟᴇᴛᴇᴅ Aᴄᴄᴏᴜɴᴛs ☠️: <code>{deleted}</code>
